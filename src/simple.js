const Simple = (selector) => {
    // Mengembalikan elemen yang dipilih
    return document.querySelector(selector);
  };
  
  // Tambahkan metode ke Simple setelah deklarasi fungsi
  Simple.click = function(selector, callback) {
    ...
    if (typeof callback !== "function") {
      console.error("Error: The second argument (callback) must be a function. Use it like: Simple.click('#selector', () => alert('hello'))");
      return;
    }
